...
def learn_benchmark_mdp(
    ...
    mdp = load_automaton_from_file(
        f"../../AALpy/DotModels/MDPs/{example}.dot", automaton_type="mdp"
    )
    ...
    eq_oracle = RandomWalkEqOracle(
        input_alphabet, sul=sul, num_steps=2000, reset_prob=0.25, reset_after_cex=True
    )
